...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=flat&logo=linkedin)](https://www.linkedin.com/in/sanjoy-chattopadhyay-390b3a1a6/)
[![Email](https://img.shields.io/badge/Email-Contact-D14836?style=flat&logo=gmail)](mailto:chattopadhyaysanjoy18@gmail.com)
[![Portfolio](https://img.shields.io/badge/Portfolio-Visit-FF5722?style=flat)](https://sanjoy-chattopadhay.github.io/portfolio/)
...
**Tech Stack:** LangChain, GPT-4, FastAPI, Tavily API, React  
[Code](https://github.com/Sanjoy-Chattopadhay) | [Demo](#)

Built a production-ready multi-agent system integrating 6+ autonomous tools with real-time web search and contextual memory. Supports 20+ concurrent users with 99% uptime through optimized FastAPI microservices and automated ReAct reasoning workflows.

### Army Medical RAG Chatbot
**Tech Stack:** LangChain, FAISS, HuggingFace, Groq, Streamlit  
[Code](https://github.com/Sanjoy-Chattopadhay) | [Demo](#)

Developed a domain-specific RAG pipeline processing 10,000+ pages of medical guidelines. Achieved 92% retrieval accuracy with 0.12s latency using FAISS vector search, semantic chunking, and Groq-accelerated inference. Recognized as a finalist in the Indian Army Innovation Contest 2025.

### Intelligent Vehicle Maintenance Platform
**Tech Stack:** LSTM/GRU, CNN, Python, MongoDB, Streamlit  
[Code](https://github.com/Sanjoy-Chattopadhay) | [Demo](#)

Built an AI-driven maintenance platform analyzing 10-year telemetry data with 87% failure prediction accuracy. Delivers real-time fleet readiness insights through Streamlit dashboards using LSTM/GRU forecasting and CNN feature extraction.
...
📅 [Schedule a Chat](https://topmate.io/sanjoy_chattopadhyay/)
